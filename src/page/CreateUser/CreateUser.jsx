      ...
      case 0:
        return <form className='space-y-3' onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input type="date" name='birthday' className='border border-gray-400 rounded-md p-2' format="DD-MM-YYYY" onChange={(event) => {
      ...
      case 1:
        return <div>
          <form onSubmit={handleUploadAvatar}>
            ...
            <button type='submit' className='py-2 px-5 bg-black text-white'>Upload Hình</button>
          </form>
        </div>
    }
  }
